    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm md:text-base text-gray-600 mt-1">Monitor your coffee roasting and brewing operations</p>
        </div>
        <div className="flex items-center gap-3">
          <div className="bg-white rounded-lg shadow px-3 md:px-4 py-2 flex items-center gap-2">
            <TrendingUp className="h-4 w-4 md:h-5 md:w-5 text-green-600" />
            <span className="text-xs md:text-sm font-medium text-gray-900">Live Tracking</span>
          </div>
        </div>
      </div>
