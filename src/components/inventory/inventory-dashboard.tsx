...
export function InventoryDashboard() {
  ...
  const getFreshnessStatus = (daysSinceRoast: number) => {
    ...
    return { status: 'Aging', color: 'bg-espresso-light text-cream' }
  }
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[1, 2].map(i => (
            <div key={i} className="bg-espresso-light rounded-lg shadow p-6">
              <div className="animate-pulse">
                <div className="h-4 bg-espresso-light/60 rounded w-1/4 mb-4"></div>
                <div className="space-y-3">
                  <div className="h-3 bg-espresso-light/60 rounded"></div>
                  <div className="h-3 bg-espresso-light/60 rounded w-5/6"></div>
                </div>
              </div>
            </div>
          ))}
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <button
          ...
          className="bg-brass hover:bg-brass-light text-espresso px-4 py-2 rounded-lg text-sm font-medium transition-colors self-start sm:self-auto"
        >
          Refresh
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
        <div className="bg-espresso-light rounded-lg shadow p-3 md:p-4">
          <div className="flex items-center gap-2 md:gap-3">
            <Coffee className="h-6 w-6 md:h-8 md:w-8 text-amber-600 flex-shrink-0" />
            <div className="min-w-0">
              <p className="text-xs md:text-sm font-medium text-cream-dark truncate">Roasted Coffee</p>
        ...
        <div className="bg-espresso-light rounded-lg shadow p-3 md:p-4">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs md:text-sm font-medium text-cream-dark truncate">Green Coffee</p>
        ...
        <div className="bg-espresso-light rounded-lg shadow p-3 md:p-4">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs md:text-sm font-medium text-cream-dark truncate">Roasted Batches</p>
        ...
        <div className="bg-espresso-light rounded-lg shadow p-3 md:p-4">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs md:text-sm font-medium text-cream-dark truncate">Green Origins</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-espresso-light rounded-lg shadow">
          <div className="p-6 border-b border-brass">
            ...
            <p className="text-sm text-cream-dark">Current roasted coffee inventory with freshness tracking</p>
          </div>
          <div className="p-6">
            {roastedCoffee.length === 0 ? (
              <div className="text-center py-8">
                <Coffee className="h-12 w-12 text-cream mx-auto mb-4" />
                <p className="text-cream-dark">No roasted coffee in inventory</p>
                <p className="text-sm text-cream-dark mt-1">Complete a roast to see it here</p>
              </div>
            ) : (
              <div className="space-y-4">
                {roastedCoffee.map((coffee, index) => {
                  ...
                  return (
                    <div key={index} className="border border-brass rounded-lg p-3 md:p-4">
                      ...
                      <div className="mb-3">
                        ...
                        <div className="w-full bg-espresso-light/60 rounded-full h-2">
                          <div 
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm text-cream-dark">
                        <div>
                      ...
                      <div className="mt-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                        <p className="text-xs text-cream-dark">{coffee.days_since_roast} days since roast</p>
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <button
                            ...
                            className="bg-brass hover:bg-brass-light text-espresso text-xs px-2 py-1 rounded flex items-center gap-1 transition-colors disabled:opacity-50"
        ...
        <div className="bg-espresso-light rounded-lg shadow">
          <div className="p-6 border-b border-brass">
            ...
            <p className="text-sm text-cream-dark">Unroasted coffee beans ready for roasting</p>
          </div>
          <div className="p-6">
            {greenCoffee.length === 0 ? (
              <div className="text-center py-8">
                <Package className="h-12 w-12 text-cream mx-auto mb-4" />
                <p className="text-cream-dark">No green coffee in inventory</p>
                <p className="text-sm text-cream-dark mt-1">Add a green coffee purchase to see it here</p>
              </div>
            ) : (
              <div className="space-y-4">
