-- Revert to the working version of calculate_roasted_inventory
-- This version worked before and just needs to include 'roasted_adjustment' in the action types
